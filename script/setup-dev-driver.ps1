...
$Volume = New-VHD -Path C:/gram_dev_drive.vhdx -SizeBytes 100GB |
                    Mount-VHD -Passthru |
...
Dismount-VHD -Path C:/gram_dev_drive.vhdx
Mount-VHD -Path C:/gram_dev_drive.vhdx
